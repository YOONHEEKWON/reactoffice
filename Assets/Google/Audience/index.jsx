...
import { loadAssetTablDdata } from 'ai/pages/Assets/Google/Audience/action';
import './styles.scss';
...
class GoogleAudience extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    //const quickLookList = this.state.quickLookList
...
GoogleAudience.propTypes = {
  ...
  loadAssetTablDdata: PropTypes.func.isRequired,
...
function mapStateToProps(state) {
  return {
    ...
    Assettabledatalist: state.assets.googleAudience.Assettabledatalist,
  };
}
